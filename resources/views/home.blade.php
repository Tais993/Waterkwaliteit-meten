                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="d-grid gap-2 col-6 mx-auto" id="admin-p">
                                ...
                                <button class="btn btn-danger" type="button"><a class="dropdown-item" href="{{ route('logout') }}"
                                    onclick="event.preventDefault();
                                                  document.getElementById('logout-form').submit();">
                                 <i class="fa-solid fa-right-from-bracket" style="color: #fff;"></i> Log out</a></button>
                            </div>
                        </div>
                    </div>
                </div>
